<x-guest-layout maxWidth="sm:max-w-3xl">
    <div class="mb-8 text-center">
        ...
        <p class="text-xs text-gray-400 mt-1"><span class="text-red-500">*</span> Wajib diisi</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-8">
        ...
        <div>
            ...
            <div class="bg-gray-50/80 p-5 rounded-2xl border border-gray-100 space-y-4 shadow-inner">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <x-input-label for="nama_lengkap" class="font-medium text-gray-700">Nama Lengkap <span class="text-red-500">*</span></x-input-label>
                    ...
                    <div>
                        <x-input-label for="username" class="font-medium text-gray-700">Username <span class="text-red-500">*</span></x-input-label>
                ...
                <div>
                    <x-input-label for="email" class="font-medium text-gray-700">Alamat Email <span class="text-red-500">*</span></x-input-label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div x-data="{ show: false }">
                        <x-input-label for="password" class="font-medium text-gray-700">Kata Sandi <span class="text-red-500">*</span></x-input-label>
                    ...
                    <div x-data="{ show: false }">
                        <x-input-label for="password_confirmation" class="font-medium text-gray-700">Konfirmasi Sandi <span class="text-red-500">*</span></x-input-label>
                        <div class="relative mt-1">
        ...
        <div>
            ...
            <div class="bg-gray-50/80 p-5 rounded-2xl border border-gray-100 space-y-4 shadow-inner">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <x-input-label for="nis" class="font-medium text-gray-700">Nomor Induk Siswa (NIS) <span class="text-red-500">*</span></x-input-label>
                    ...
                    <div>
                        <x-input-label for="tanggal_lahir" class="font-medium text-gray-700">Tanggal Lahir <span class="text-gray-400 text-xs font-normal">(opsional)</span></x-input-label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <x-input-label for="kelas" class="font-medium text-gray-700">Kelas <span class="text-red-500">*</span></x-input-label>
                    ...
                    <div>
                        <x-input-label for="jurusan" class="font-medium text-gray-700">Jurusan <span class="text-gray-400 text-xs font-normal">(opsional)</span></x-input-label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <x-input-label for="telepon" class="font-medium text-gray-700">Nomor WhatsApp/Telepon <span class="text-gray-400 text-xs font-normal">(opsional)</span></x-input-label>
                    ...
                    <div>
                        <x-input-label for="alamat" class="font-medium text-gray-700">Alamat Domisili <span class="text-gray-400 text-xs font-normal">(opsional)</span></x-input-label>
